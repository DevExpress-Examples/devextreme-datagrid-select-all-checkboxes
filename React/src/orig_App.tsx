...
function App(): JSX.Element {
  ...
  const groupRowInit = (arg: IGroupRowReadyParameter): void => { helper?.groupRowInit(arg); };

  // eslint-disable-next-line func-style
  const groupCellRender = (group: DataGridTypes.ColumnGroupCellTemplateData): JSX.Element => (
    <GroupRowComponent
      groupCellData={group}
